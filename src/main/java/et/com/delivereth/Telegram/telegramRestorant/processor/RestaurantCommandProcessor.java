...
public class RestaurantCommandProcessor {
    ...
    public RestaurantCommandProcessor(RequestForMenu requestForMenu, RequestLocation requestLocation, RequestErrorResponder requestErrorResponder, RequestForMyOrdersList requestForMyOrdersList, RequestForHelp requestForHelp, DbUtility dbUtility) {
