...
/**
 * A DTO for the {@link et.com.delivereth.domain.KeyValuPairHoler} entity.
 */
public class KeyValuPairHolerDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        KeyValuPairHolerDTO keyValuPairHolerDTO = (KeyValuPairHolerDTO) o;
        if (keyValuPairHolerDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), keyValuPairHolerDTO.getId());
    }
