...
export class FoodComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.foodService
      ...
      .subscribe(
        (res: HttpResponse<IFood[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInFoods(): void {
    this.eventSubscriber = this.eventManager.subscribe('foodListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IFood[] | null, headers: HttpHeaders, page: number): void {
