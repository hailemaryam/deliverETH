...
describe('Service Tests', () => {
  describe('OrderedFood Service', () => {
    let injector: TestBed;
    let service: OrderedFoodService;
    let httpMock: HttpTestingController;
    let elemDefault: IOrderedFood;
    let expectedResult: IOrderedFood | IOrderedFood[] | boolean | null;
    ...
    describe('Service methods', () => {
      ...
      it('should create a OrderedFood', () => {
        ...
        service.create(new OrderedFood()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should delete a OrderedFood', () => {
