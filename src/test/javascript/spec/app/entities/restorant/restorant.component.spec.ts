...
import { RestorantComponent } from 'app/entities/restorant/restorant.component';
...
describe('Component Tests', () => {
  describe('Restorant Management Component', () => {
    let comp: RestorantComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RestorantComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.restorants && comp.restorants[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
